...
def detect_and_test_with_visuals(video_path, json_path, gaze_data,
                                 frame_no=30):
    
    test_pt = (gaze_data['gaze_x_px'][frame_no],gaze_data['gaze_y_px'][frame_no])
...
if __name__ == "__main__":
    video_file = '/Users/stabatabaeim/Library/CloudStorage/OneDrive-TheUniversityofMelbourne/University/Year 2/Experiment/EyeTracker/Data/Participant 8/2025-03-24-10-07-36/Neon Scene Camera v1 ps1.mp4'
    json_file = '/Users/stabatabaeim/Library/CloudStorage/OneDrive-TheUniversityofMelbourne/University/Year 2/Experiment/EyeTracker/Data/Participant 7/Timeseries Data + Scene Video/2025-03-20_14-07-13-dd7df7bd/scene_camera.json'
    gaze_file = '/Volumes/R@mtin/Year 2/Experiment/EyeTracker/Data/Participant 8/Video_Gaze_Aruco.csv'

    gaze_data = pd.read_csv(gaze_file)
    # print(gaze_data['gaze_x_px'][0])

    detect_and_test_with_visuals(
        video_file,
        json_file,
        gaze_data,
        frame_no=584)
