...
#This one is same as preious one but here I am changing the failure duration to the the time exactly a failure happen. 
    ...
    for i in range(1,55):
        ...
        for puzzle in range(1,7):
            ...
            for object_number in range(1,5):
                ...
                sub = sub[(sub["state"] >= 5) & (sub["state"] <= 8)]
                ...
                rec = {
                    ...
                    "num_gaze_shifts": shift_count/Calculate_time(sub),
                    "robot_head_gaze_shifts": gaze_shift_counter(seq, numebr_of_puzzles, "robot_head")/Calculate_time(sub),
                    "robot_pieces_gaze_shifts": gaze_shift_counter(seq, numebr_of_puzzles, "robot_pieces")/Calculate_time(sub),
                    "EndEffector_gaze_shifts": gaze_shift_counter(seq, numebr_of_puzzles, "end_effector")/Calculate_time(sub),
